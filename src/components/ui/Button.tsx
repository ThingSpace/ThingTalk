...
const ButtonStyles = cva(
	'flex p-3 my-2 border-2 text-center justify-center items-center duration-200 disabled:opacity-50 disabled:cursor-not-allowed',
	{
		variants: {
			styles: {
				...
				exotic: 'bg-black text-white border-black hover:bg-pink-600 hover:text-white hover:border-pink-600',
