...
const AboutPage: NextPage<AboutPageProps> = ({ stats }) => {
    ...
    return (
        ...
        >
            <NextSeo title="About Us" description="Learn more about A Thing and our mission for anonymous self-expression." />
            ...
            <div className="flex w-full max-w-4xl flex-col gap-8">
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    <motion.div 
                        className="flex flex-col gap-6 border-2 bg-white p-8 hover:border-black"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                ...
                <motion.div 
                    ...
                    <div className="mt-4 flex gap-4">
                        <a href="https://github.com/ThingSpace/TheThing" className="text-blue-600 hover:underline">GitHub</a>
                        <a href="https://twitter.com/theathingapp" className="text-blue-600 hover:underline">Twitter</a>
                    </div>
                </motion.div>
            </div>
        </motion.div>
...
export const getStaticProps = async () => {
    ...
    const notesCount = await prisma.post.count({ where: { isPublished: true } });
    const journalsCount = await prisma.journal.count();
    const countriesCount = await getCloudflareAnalytics();
