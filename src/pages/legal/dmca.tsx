...
const DMCAPage: NextPage = () => {
    ...
    return (
        <motion.div
            ...
            <NextSeo title="DMCA Policy" description="DMCA Policy for A Thing" />
                ...
                <div className="flex flex-col gap-6">
                    <section className="flex flex-col gap-3">
                        <p className="font-normal">
                            A Thing respects intellectual property rights and expects its users to do the same. We respond to notices of alleged copyright infringement in accordance with the Digital Millennium Copyright Act (DMCA).
                        </p>
                    </section>
                    ...
                    <section className="flex flex-col gap-3">
                        ...
                        <p className="font-normal">If you believe your content was wrongly removed, you may submit a counter-notice containing:</p>
                        <ul className="list-decimal pl-6 font-normal">
                    ...
                    <section className="flex flex-col gap-3">
                        ...
                        <p className="font-normal">
                            Submit DMCA notices through:
                        </p>
                        <ul className="list-disc pl-6 font-normal">
                            <li>Email: <a href="mailto:dmca@athing.space" className="text-blue-600 hover:underline">dmca@athing.space</a></li>
                            <li><a href="https://github.com/ThingSpace/TheThing/issues" className="text-blue-600 hover:underline">GitHub Issues</a></li>
                        </ul>
                    </section>
                </div>
            </div>
