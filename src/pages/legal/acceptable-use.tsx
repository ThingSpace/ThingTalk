...
const AcceptableUsePage: NextPage = () => {
    ...
    return (
        <motion.div
            ...
            <NextSeo title="Acceptable Use Policy" description="Acceptable Use Policy for A Thing" />
                ...
                <div className="flex flex-col gap-4">
                    <section>
                        ...
                        <p className="font-normal">
                            - Personal expression and journaling<br />
                            - Sharing experiences anonymously<br />
                            - Supporting other community members<br />
                    ...
                    <section>
                        ...
                        <p className="font-normal">
                            ...
                            - Personal attacks or harassment<br />
                            - Explicit or adult content<br />
                            - Spam or commercial promotion<br />
                            - Impersonation or identity theft<br />
                    ...
                    <section>
                        ...
                        <p className="font-normal">
                            - Keep interactions respectful<br />
                            - Use content warnings when appropriate<br />
                            - Avoid sharing identifiable information<br />
                    ...
                    <section>
                        ...
                        <p className="font-normal">
                            ...
                            - No automated posting<br />
                            - No circumventing bans<br />
                    ...
                    <section>
                        ...
                        <p className="font-normal">
                            - Violations result in content removal<br />
                            - Repeated violations lead to account suspension<br />
                            - Serious violations result in immediate permanent ban<br />
